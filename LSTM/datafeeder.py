...
class McepDataSet(Dataset):
    ...
    def __init__(self, ssp, tsp, data_root, scp):
        ...
        # get the dataset ids
        with io.open(scp, 'r', encoding='utf-8') as f:
    ...
    def __getitem__(self, idx):
        ...
        source_path = os.path.join(self.data_root, "arctic_{1}-mc.npy".format(self.ssp, wav_id))
        target_path = os.path.join(self.data_root, "arctic_{1}-mc.npy".format(self.tsp, wav_id))
